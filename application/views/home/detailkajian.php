...
<body style='background: #343A40'>
    ...
    <div id="#back-to-top" class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link text-secondary" href="<?= base_url(); ?>home#program">Program</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-white" href="<?= base_url(); ?>home#kajian">Kajian</a>
          </li>
          <li class="nav-item">
  ...
  <div class="container mt-5">
    <br>
    <h3 class="text-white">Tema: <?= $kajian['tema']; ?></h3>
    <div class="row mb-5">
      <div class="col-6">
        <img src="<?= base_url(); ?>/assets/img/kajian/<?= $kajian['image']; ?>" class="img-detail-event mt-0" style="width: 30rem;">
      </div>
      <div class="col-6">
        <table class="table text-white mt-0">
          <tbody>
            <tr>
              <th style="width:100px;">Waktu</th>
              <td>: <?= date('j M Y', strtotime($kajian['waktu'])); ?></td>
            </tr>
            <tr>
            ...
            <tr>
              <th style="width:100px;">Pemateri</th>
              <td>: <?= $kajian['pemateri']; ?></td>
            </tr>
          </tbody>
        </table>

        <p class="text-white justify-content-center mb-5">
          <br><?= $kajian['desc']; ?>
        </p>
      </div>
    </div>
