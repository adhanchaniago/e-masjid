...
class Menu extends CI_Controller
{
  ...
  public function deleteMenu($id)
  {
    ...
    $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Menu telah dihapus</div>');
    redirect('menu');
  }
  ...
  public function deleteSubMenu($id)
  {
    ...
    $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Sub Menu telah dihapus</div>');
    redirect('menu/submenu');
  }
}
